...
这样的系统特征根在虚轴上（中心流形）, 他们的响应通常是持续震荡的，所以寻找  $t_f$  变为寻找  $t_cycle$  .
$\varDelta _{0\_marg.stable}=\frac{\left| \int_0^{t_{cycle}}{y_{True}dt} \right|-\left| \int_0^{t_{cycle}}{y_{lin}dt} \right|}{\left| \int_0^{t_{cycle}}{y_{True}dt} \right|}$
### for unstable system
