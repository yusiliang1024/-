...
### SINDYc (Sparse Identification of Nonlinear Dynamics with control) and SINDy (Sparse Identification of Nonlinear Dynamics)
粗略识别是否含有某个nonlinearity，解最小二乘法问题
- SINDy：通过一个candidate 库存储高阶多项式，三角函数和log函数来辨识未知的过程。
  - 缺点：库太大了可能会对预测输出产生不必要的震荡；且计算负担大；可能会产生过拟合 
- kSINDYc：通过 term  $k_{nl}$  来约束候选库
<img width="212" height="102" alt="image" src="https://github.com/user-attachments/assets/aa259e2a-4810-4a24-9c10-6ff8b5d3b47e" />  
<img width="480" height="98" alt="image" src="https://github.com/user-attachments/assets/8eb6d8a1-43f1-429f-b4b9-6b5bf0428f1b" />
$\lambda$  代表了稀疏度，也是惩罚系数  
### NL2SQ（Nonlinear least square） with L-M algorithm
对于识别到的粗略模型进行参数的精调
1. 构造目标函数  $f(x)$  
<img width="299" height="100" alt="image" src="https://github.com/user-attachments/assets/fbefc796-60f0-4790-bffa-031ff31be7ef" />
<img width="325" height="112" alt="image" src="https://github.com/user-attachments/assets/211ab1b1-a873-43a1-acfc-3128fcb7b535" />
2. 目标函数梯度：
<img width="434" height="89" alt="image" src="https://github.com/user-attachments/assets/fab5686f-6f1e-4a62-ba45-4582fae1c355" />
其中
<img width="448" height="173" alt="image" src="https://github.com/user-attachments/assets/bac8cf10-4278-409b-b9e9-d8f9cd6d0ff8" />
Hessian矩阵为
<img width="487" height="165" alt="image" src="https://github.com/user-attachments/assets/926b7084-4716-46f6-9f93-685b3b4b9e93" />
其中可以把二次项省略从而近似。
### N3ARX结合神经网络的非线性辨识
